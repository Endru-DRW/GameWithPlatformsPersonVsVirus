...
namespace GameWithPlatformsPersonVsVirus.Game
{
    public partial class Level5Game : Form
    {
        ...
        private void MainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            if (horizontalPlatform.Left < 12 || horizontalPlatform.Left > 284)
            {
            ...
            if (verticalPlatform.Top < 407 || verticalPlatform.Top > 522)
            {
            ...
            if (player.Bounds.IntersectsWith(door.Bounds))
            {
                ...
                Level6Game nextLevel = new Level6Game();
                nextLevel.Show();
                Visible = false;
            }
        }
